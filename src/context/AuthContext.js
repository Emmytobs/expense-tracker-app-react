...
export const AuthProvider = ({ children }) => {
    ...
    const loginUser = async (loginData) => {
        try {
            ...
            const response = await axios.post('https://emmytobs-expense-tracker-api.herokuapp.com/user/login', loginData);
    ...
    const signUpUser = async (signUpData) => {
        try {
            const response = await axios.post('https://emmytobs-expense-tracker-api.herokuapp.com/user/signup', signUpData);
            // Destructure the data object from the response
            const { data } = response;
            // Create a user variable to only contain the username and the token
    ...
    const logoutUser = async () => {
        try {
            const response = await axios.delete("https://emmytobs-expense-tracker-api.herokuapp.com/user/logout", {
                headers: {
